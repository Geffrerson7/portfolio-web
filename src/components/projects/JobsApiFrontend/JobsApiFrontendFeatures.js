    ...
    <div className="my-32 dark:text-light">
      ...
      <div ref={ref} className="w-[75%] mx-auto relative lg:w-[90%] md:w-full">
        ...
        <ul className="w-full flex flex-col items-start justify-between ml-4 xs:ml-2">
          ...
          <Features
            name="Jobs section"
            info="The application has a section for the CRUD of jobs."
          />
          <Features
            name="Web Portals section"
            info="The application has a section for the CRUD of web portals."
          />
        </ul>
      </div>
    </div>
...
export default JobsApiFrontendFeatures;
