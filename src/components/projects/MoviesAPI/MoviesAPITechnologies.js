            ...
            <div ref={ref} className='w-[75%] mx-auto relative lg:w-[90%] md:w-full'>
                ...
                <ul className='w-full flex flex-col items-start justify-between ml-4 xs:ml-2'>
                    ...
                    <Technologies
                        ...
                        description="Dotenv is a package available on npm (Node Package Manager) for Node.js applications that loads environment variables from a .env file into the process.env object. It is commonly used to separate configuration data from code and to keep sensitive information like API keys, passwords, and other credentials out of version control systems. "
                    />
                </ul>
            </div>
        </div>
...
export default MoviesAPITechnologies