...
const Experience = () => {
  ...
  return (
    <div className='my-64'>
            ...
            <div ref={ref} className='w-[75%] mx-auto relative lg:w-[90%] md:w-full mt-16'>
                <motion.div style={{ scaleY: scrollYProgress }} className='absolute left-9 top-0 w-[4px] h-full bg-dark origin-top dark:bg-light md:w-[2px] md:left-[30px] xs:left-[20px]' />
                <ul className='w-full flex flex-col items-start justify-between ml-4 xs:ml-2'>
                    <Details
                        position="Marketplace Content and SKU Assistant"
                        company="Silabuz"
                        companyLink="https://www.silabuz.com/"
                        time="January 2024 - Present"
                        address="Miraflores, Lima, Peru"
                        work="Responsible for analyzing, reviewing, and managing KPIs of content and ensuring proper management of business activities alongside Yape Market's commercial executives."
                    />
                    <Details
