...
import profilePic from '../../public/images/profile/dino-developer.png'
        ...
        <Layout className='pt-0 md:p-16 sm:pt-8'>
          <div className='flex items-center justify-between w-full lg:flex-col'>
            <div className='w-1/2 md:w-full'>
              <Image src={profilePic} alt="CodeGef" className='w-full h-auto lg:hidden md:inline-block md:w-full'
                priority
            ...
            <div className='w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center'>
              ...
              <AnimatedText text='Hi, I&#39;m Gefferson Casasola' className='!text-6xl !text-left xl:!text-5xl lg:!text-center lg:!text-6xl md:!text-5xl sm:!text-3xl' />
              ...
              <div className='flex items-center self-start mt-2 lg:self-center'>
                <Link href="https://storage.rxresu.me/clp9fxo7l86s49hun51gu1vkk/resumes/CV-GEF.pdf" target="_blank"
                ...
                <Link href="mailto:gefferson.casasola@gmail.com" target="_blank"
